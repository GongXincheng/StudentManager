	...
	<nav class="navbar navbar-default">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <!-- logo -->
          <a class="navbar-brand" href="${indexUrl}">学生信息管理</a>
        </div>
    
    	<!-- Nav Bar -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="${indexUrl}/dept/deptList.html">院系管理</a></li>
            <li><a href="${indexUrl}/spe/spetList.html">专业管理</a></li>
            ...
            <li class="dropdown">
			  ...
			  <ul class="dropdown-menu" aria-labelledby="dLabel">
			    <li><a href="${indexUrl}/stu/stuList.html">学生列表</a></li>
            	<li><a href="${indexUrl}/stu/addStuPage.html">学生信息录入</a></li>
			  </ul>
			</li>
